...
Java_fun_upup_musicfree_cenc_CencNative_nativeCreate(
    JNIEnv* env,
    jobject,
...
Java_fun_upup_musicfree_cenc_CencNative_nativeIsValid(JNIEnv*, jobject, jlong handle) {
    auto* decoder = decoderFrom(handle);
    return decoder && decoder->ok() ? JNI_TRUE : JNI_FALSE;
}

extern "C" JNIEXPORT jstring JNICALL
Java_fun_upup_musicfree_cenc_CencNative_nativeGetError(JNIEnv* env, jobject, jlong handle) {
    auto* decoder = decoderFrom(handle);
...
Java_fun_upup_musicfree_cenc_CencNative_nativeGetHeader(JNIEnv* env, jobject, jlong handle) {
    auto* decoder = decoderFrom(handle);
...
extern "C" JNIEXPORT jlong JNICALL
Java_fun_upup_musicfree_cenc_CencNative_nativeGetHeaderSize(JNIEnv*, jobject, jlong handle) {
    auto* decoder = decoderFrom(handle);
    return decoder ? static_cast<jlong>(decoder->headerSize()) : 0;
}

extern "C" JNIEXPORT jlong JNICALL
Java_fun_upup_musicfree_cenc_CencNative_nativeGetMdatFileOffset(JNIEnv*, jobject, jlong handle) {
    auto* decoder = decoderFrom(handle);
    return decoder ? static_cast<jlong>(decoder->mdatFileOffset()) : 0;
}

extern "C" JNIEXPORT jlong JNICALL
Java_fun_upup_musicfree_cenc_CencNative_nativeGetOutputTotalSize(JNIEnv*, jobject, jlong handle) {
    auto* decoder = decoderFrom(handle);
    return decoder ? static_cast<jlong>(decoder->outputTotalSize()) : 0;
}

extern "C" JNIEXPORT void JNICALL
Java_fun_upup_musicfree_cenc_CencNative_nativeDecrypt(
    JNIEnv* env,
    jobject,
    jlong handle,
...
extern "C" JNIEXPORT void JNICALL
Java_fun_upup_musicfree_cenc_CencNative_nativeDestroy(JNIEnv*, jobject, jlong handle) {
